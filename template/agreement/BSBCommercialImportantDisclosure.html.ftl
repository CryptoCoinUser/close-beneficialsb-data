<div>
  <style>
	...
	<div>
		<h2>Pricing and Terms for Commercial Credit Card</h2>
		<table class="table">
			<col width="30%">
			<col width="70%">
			<tbody>
				...
				<tr>
					...
					<td>Your APR will be <b class='apr'>9.65%</b> for unsecured and <b class='apr'>8.65%</b> for cash secured Commercial Credit Card accounts. This APR will vary with the market based on the Prime Rate.</td>
				</tr>
				<tr>
